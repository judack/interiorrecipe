export const SITE = {
  name: "인테리어레시피",
  alternateName: "Interior Recipe",
  // 검색엔진(네이버/구글) 등록, sitemap 생성, canonical/JSON-LD 등에 쓰이는 실제 배포 주소입니다.
  // 커스텀 도메인(interior-recipe.co.kr)이 연결되어 www 서브도메인으로 반영되었습니다.
  baseUrl: "https://www.interior-recipe.co.kr",
